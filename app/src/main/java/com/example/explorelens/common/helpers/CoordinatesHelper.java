...
public class CoordinatesHelper {
    ...
    public Coordinate GetLocalCoordinates(LatLng point_, double yaw) {
        ...
        Log.d("tag", "Center x: " + center_.getLatitude());
        Log.d("tag", "Center y: " + center_.getLongitude());

        // converting the lat long of the location or the poi to local coordinates
        Coordinate mainPoint = converter.toCartesian(point_.getLatitude(), point_.getLongitude());
