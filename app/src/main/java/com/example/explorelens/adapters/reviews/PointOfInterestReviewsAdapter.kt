package com.example.explorelens.adapters.reviews
...
class PointOfInterestReviewsAdapter : ListAdapter<Review, PointOfInterestReviewsAdapter.ReviewViewHolder>(ReviewDiffCallback()) {
